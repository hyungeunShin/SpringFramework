						...
						<form class="card card-primary" method="post" action="/board/insert.do" id="boardForm">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" id="boTitle" class="form-control" name="boTitle" placeholder="제목을 입력해주세요" value="${board.boTitle}">
								</div>
								<div class="form-group">
...
$(function() {
	...
	CKEDITOR.config.allowedContent = true; //html 태그가 사라지는걸 방지
	...
	btn.on('click', function() {
		...
		//let content = $('#boContent').val(); //ckeditor를 쓰면 이 방식으로 못가져옴
		let content = CKEDITOR.instances.boContent.getData(); //내용 얻어오는 법
		...
		//등록일 때와 수정일 때 구분해서 방향만 살짝 틀어주면 등록이되고 수정이된다
		if($(this).val() == "수정") {
