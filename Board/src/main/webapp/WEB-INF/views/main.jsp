							...
							<c:choose>
								...
								<c:otherwise>
									<c:forEach items="${boardList}" var="board">
										<tr class="boardtr" data-no="${board.boNo}">
											<td>${board.boNo}</td>
											<td>${board.boTitle}</td>
											<td>${board.boDate}</td>
										</tr>
							...
							<c:choose>
								...
								<c:otherwise>
									<c:forEach items="${noticeList}" var="notice">
										<tr class="noticetr" data-no="${notice.boNo}">
											<td>${notice.boNo}</td>
							...
							<c:choose>
								...
								<c:otherwise>
									<c:forEach items="${freeList}" var="free">
										<tr class="freetr" data-no="${free.boNo}">
											<td>${free.boNo}</td>
											<td>${free.boTitle}</td>
											<td>${free.boDate}</td>
										</tr>
