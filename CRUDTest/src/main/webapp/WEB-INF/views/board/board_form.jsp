		...
		<div class="container-fluid px-2 px-md-4">
			...
			<div class="card card-body mx-3 mx-md-4 mt-n6">
				<div class="row gx-4 mb-2">
					...
					<div class="col-md-12">
						<button type="button" class="btn btn-primary" id="formBtn">${name}</button>
						<c:if test="${status eq 'u'}">
							<a href="/board/detail/${board.boNo}"><button type="button" class="btn btn-danger">취소</button></a>
						</c:if>
						<c:if test="${status ne 'u'}">
							<a href="/board/boardList"><button type="button" class="btn btn-info">목록</button></a>
						</c:if>
					</div>
				</div>
			</div>
