					...
					<ul class="navbar-nav  justify-content-end">
						...
						<li class="nav-item">
							<div class="d-flex align-items-center justify-content-between">
								<div class="avatar-group mt-2 avatar avatar-xs rounded-circle">
									<img alt="Image placeholder" src="${pageContext.request.contextPath}/resources/img/team-1.jpg" style="width: 40px; margin-right: 30px;">
								</div>
							</div>
						</li>
						<li class="nav-item d-flex align-items-center"></li>
						<li class="nav-item d-flex align-items-center">
							<div class="d-flex flex-column justify-content-center">
								<h6 class="mb-0 text-sm">${member.memName}</h6>
				...
				<div class="col-12">
					<div class="card my-4">
						...
						<div class="card-body px-0 pb-2">
							<div class="row">
								<!-- form -->
								<form class="input-group input-group-outline" action="/board/boardList" id="searchForm">
									...
									<tbody>
										...
										<c:choose>
											<c:when test="${empty list}">
												<tr class="text-center">
													<td colspan="5" class="text-dark font-weight-bolder">
														조회하신 게시글이 존재하지 않습니다.
													</td>
												</tr>
											</c:when>
											<c:otherwise>
												<c:forEach items="${list}" var="board">
													<tr class="text-center">
														<td>${board.boNo}</td>
														<td class="text-dark"><a href="/board/detail/${board.boNo}">${board.boTitle}</a></td>
						...
						<a href="/board/boardInsertForm" style="margin: 10px;"><button type="button" class="btn btn-outline-secondary">게시글 작성</button></a>
						<div id="pagingArea">
