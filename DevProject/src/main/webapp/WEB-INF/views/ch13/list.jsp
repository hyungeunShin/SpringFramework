				...
				<div class="card">
					<div class="card-header">
						<div class="card-tools">
							<!-- 검색 -->
							<form class="input-group input-group-sm" style="width: 440px;" method="post" id="searchForm" action="/notice/list">
								...
								<c:choose>
									...
									<c:otherwise>
										<c:forEach items="${noticeList}" var="notice">
											<tr>
												<td>${notice.boNo}</td>
												<td><a href="/notice/detail?boNo=${notice.boNo}">${notice.boTitle}</a></td>
